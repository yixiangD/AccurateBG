...
def visualization(ori_data, generated_data, analysis, args):
    ...
    if analysis == "pca":
        ...
        plt.ylabel("y_pca")
        plt.savefig(
            f"./results/{args.hidden_dim}_{args.num_layer}_{args.batch_size}pca.png"
        )
        plt.show()
        ...
        plt.savefig(
            f"./results/{args.hidden_dim}_{args.num_layer}_{args.batch_size}tsne.png"
        )
        ax.legend()
